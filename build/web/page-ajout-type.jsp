                      ...
                      <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                          ...
                          <div class="card-body">
                            ...
                            <div class="pt-4 pb-2">
                              <h5 class="card-title text-center pb-0 fs-4">Add a type</h5>
                              <p class="text-center small">Enter just the name of type</p>
                            </div>
          
                            <form action="AjoutType" class="row g-3 needs-validation" novalidate>
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="col-12">
                                <button class="btn btn-primary w-100" type="submit">Add Look</button>
                              </div>
