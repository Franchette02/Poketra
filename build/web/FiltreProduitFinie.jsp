                      ...
                      <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                          ...
                          <div class="card-body">
                            ...
                            <div class="pt-4 pb-2">
                              <h5 class="card-title text-center pb-0 fs-4">Filtre Produit Finie</h5>
                       
                            </div>
          
                            <form action="Filtrer" class="row g-3 needs-validation" novalidate>
                              <div class="col-md-12">
                                <div class="form-floating">
                                    <input name="pmin" type="text" class="form-control" id="floatingName" placeholder="Size" required>
                                    <label for="floatingName"> Prix Min</label>
                                    <div class="invalid-feedback">Please, enter a min</div>
                                </div>
                              </div>
                                 <div class="col-md-12">
                                <div class="form-floating">
                                    <input name="pmax" type="text" class="form-control" id="floatingName" placeholder="Size" required>
                                    <label for="floatingName">Prix Max</label>
                                    <div class="invalid-feedback">Please, enter a max</div>
                                </div>
                              </div>
