                        ...
                        <div class="card mb-3">
                          ...
                          <div class="card-body">
                            ...
                            <div class="pt-4 pb-2">
                              ...
                              <form action="AjoutMatierePremiere" class="row g-3 needs-validation" novalidate>
                             
                                <div class="col-md-12">
                                    <div class="form-floating">
                                      <input name="nom" type="text" class="form-control" id="floatingName" placeholder="Your Name">
                                      <label for="floatingName">Matiere</label>
                                    </div>
                                    <br>
                                     <div class="form-floating">
                                      <input name="prix" type="text" class="form-control" id="floatingName" placeholder="Your Name">
