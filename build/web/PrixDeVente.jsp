                      ...
                      <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                          ...
                          <div class="card-body">
                            ...
                            <div class="pt-4 pb-2">
                              <h5 class="card-title text-center pb-0 fs-4">Add a price </h5>
                              <p class="text-center small">Enter just the name of Employer and the salary </p>
                            </div>
          
                            <form action="AjoutPrice" class="row g-3 needs-validation" novalidate>
                               <div class="col-md-12">
                                  ...
                                  <div class="form-floating mt-5">
                                    <input name="price" type="text" class="form-control" id="floatingName" placeholder="Nom Type" required>
                                    <label for="floatingName">price</label>
                                  <div class="invalid-feedback">Please, enter a price!</div>
                                </div>
                              </div>
                              <div class="col-12">
                                <button class="btn btn-primary w-100" type="submit">Add price</button>
                              </div>
