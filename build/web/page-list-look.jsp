...
<%
Look l = new Look();
ArrayList<Look> list = l.getAllLook();
%>
            ...
            <!-- </div>   -->
              ...
              <table class="table datatable">
                ...
                <tbody>
                    <%for(Look look : list){ %>
                  <tr>
                    <th scope="row"><%= look.getId() %></th>
                    <td><%= look.getNom() %></td>
                    <td>
                        <a href="page-ajout-list-matierePrem.jsp?idLook=<%=look.getId()%>" class=" d-flex justify-content-center">Voir matiere premiere</a>
                    </td>
                  </tr>
                    <% } %>
                </tbody>
