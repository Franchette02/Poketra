                      ...
                      <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                          ...
                          <div class="card-body">
                            ...
                            <div class="pt-4 pb-2">
                              <h5 class="card-title text-center pb-0 fs-4">Add a Genre</h5>
                              <p class="text-center small">Enter just the name of genre</p>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input name="type" type="text" class="form-control" id="floatingName" placeholder="Nom Look" required>
                                    <label for="floatingName">Your Name</label>
                                    <div class="invalid-feedback">Genre</div>
                                </div>
                              </div>
