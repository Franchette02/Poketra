            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body col-lg-12">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Stock</h5>
                  </div>

                  <form class="row g-3 needs-validation"method ="get" action="AjoutStock" novalidate>

                    <div class="col-12">
                        <label class="col-sm-2 col-form-label">Types</label>
                        <div class="col-12">
                            <select name="idMp" class="form-select" aria-label="Default select example">
                                <% 
                                    MatierePremiere m = new MatierePremiere();
                                    ArrayList<MatierePremiere> list = m.getAllMatierePremiere(); %>
                            <%for(MatierePremiere mp : list){%>
                            <option value="<%=mp.getId()%>"><%=mp.getNom()%></option>
                            <%}%>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="row" id="dd">
                        <div class="">
                           <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">prix unitaire</span>
                                <input type="text" name="prix"class="form-control" placeholder="quantite" aria-label="Username" aria-describedby="basic-addon1">
                           </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="dd">
                        <div class="">
                           <div class="input-group mb-3">
                                ...
                                <input type="date" name="date"class="form-control" placeholder="quantite" aria-label="Username" aria-describedby="basic-addon1">
                           </div>
                        </div>
                    </div>
                </br>
