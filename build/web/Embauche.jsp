                      ...
                      <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                          ...
                          <div class="card-body">
                            ...
                            <div class="pt-4 pb-2">
                              <h5 class="card-title text-center pb-0 fs-4">Add a Employer</h5>
                              <p class="text-center small">Enter just the name of Employer and the salary </p>
                            </div>
          
                            <form action="AjoutEmbauche" class="row g-3 needs-validation" novalidate>
                              
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input name="nom" type="text" class="form-control" id="floatingName" placeholder="Nom Type" required>
                                    <label for="floatingName">Nom</label>
                                    <div class="invalid-feedback">Please, enter a Nom!</div>
                                </div>
                                <div class="form-floating">
                                    <input name="prenom" type="text" class="form-control" id="floatingName" placeholder="Nom Type" required>
                                    <label for="floatingName">Prenom</label>
                                    <div class="invalid-feedback">Please, enter a Prenom!</div>
                                </div>
                                <div class="form-floating mt-5">
                                    <input name="dtn" type="date" class="form-control" id="floatingName" placeholder="Nom Type" required>
                                    <label for="floatingName">Date Naissance</label>
                                    <div class="invalid-feedback">Please, enter a Date Naissance!</div>
                                </div>
                                   <div class="form-floating mt-5">
                                    <input name="embauche" type="date" class="form-control" id="floatingName" placeholder="Nom Type" required>
                                    <label for="floatingName">Date Embauche</label>
                                    <div class="invalid-feedback">Please, enter a Date Naissance!</div>
                                </div>
                                     <div class="form-floating mt-5">
                                    <input name="th" type="text" class="form-control" id="floatingName" placeholder="Nom Type" required>
                                    <label for="floatingName">Taux Horaire</label>
                                    <div class="invalid-feedback">Please, enter aTaux Horaire!</div>
                                </div>
                              </div>
                              <div class="col-12">
