...
<%@page import="model.ProduitFini"%>
<%@page import="model.GetPoketraWithDetails"%>
<%@ page import="model.MatierePremiere,java.util.ArrayList" %>

<%
   Vector<ProduitFini> gp = (Vector<ProduitFini>)request.getAttribute("filtre");
%>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Prix Poketra</th>
                  </tr>
                </thead>
                <tbody>
                    <% for(ProduitFini matiere : gp){ %>
                  <tr>
                    <th scope="row">
                        <%= matiere.getIdTypes()%>
                    </th>
                    ...
                    <td>
                        <%= matiere.getTaille_nom() %>
                    </td>
                    <td>
                        <%= matiere.getPrix()%>  Euro
                    </td>
                  </tr>
                    <% } %>
                </tbody>
