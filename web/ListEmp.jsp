<%@page import="model.Embauche"%>
<%@page import="java.util.Vector"%>
<%@ page import="model.Look,java.util.ArrayList" %>

<%
Vector<Embauche> ve =(Vector<Embauche>)request.getAttribute("ve");
%>
          ...
          <div class="card">
            ...
            <!-- </div>   -->
              ...
              <table class="table datatable">
                ...
                <tbody>
                    <%for(Embauche embauche : ve){ %>
                  <tr>
                    <th scope="row"><%= embauche.getId() %></th>
                    <td><%= embauche.getNom() %></td>
                    <td><%=embauche.getPrenom() %></td>
                    <td><%= embauche.getDate() %></td>
                    <td><%= embauche.getEmbauche()%></td>
                    <td><%= embauche.getNomExpertise() %></td>
                    <td><%= embauche.getExpe() %></td>
                    <td><%= embauche.getTh() %></td>
