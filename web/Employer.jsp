                      ...
                      <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                          ...
                          <div class="card-body">
                            ...
                            <form action="AjoutEmp" class="row g-3 needs-validation" novalidate>
                              
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input name="nom" type="text" class="form-control" id="floatingName" placeholder="Nom Type" required>
                                    <label for="floatingName">The types</label>
                                    <div class="invalid-feedback">Please, enter a Employer!</div>
                                </div>
                                <div class="form-floating mt-5">
                                    <input name="sal" type="text" class="form-control" id="floatingName" placeholder="Nom Type" required>
                                    <label for="floatingName">Salary</label>
                                    <div class="invalid-feedback">Please, enter a salary!</div>
                                </div>
                              </div>
                              <div class="col-12">
                                <button class="btn btn-primary w-100" type="submit">Add Employer</button>
                              </div>
