...
<%
   Vector<Benefice> gp = (Vector<Benefice>)request.getAttribute("ben");
%>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">benefice Poketra</th>
                  </tr>
                </thead>
                <tbody>
                    <% for(Benefice matiere : gp){ %>
                  <tr>
                    <th scope="row">
                        <%= matiere.getT().getNom()%>
                    </th>
                    <td>
                        <%= matiere.getTaille().getNom() %>
                    </td>
                    <td>
                        <%= matiere.getBenefice() %> AR
                    </td>
                  </tr>
                    <% } %>
                </tbody>
